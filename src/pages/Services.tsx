...
import { Bot, Cog, Wrench, ChevronRight, Lightbulb } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    ...
    {
      title: 'On Demand Design and Prototyping',
      description: 'Catalyst offers easy-to-purchase access to our design and prototyping expertise. Purchase time and material blocks for rapid design and prototyping.',
      icon: Lightbulb,
      image: '/images/services/engineering.jpg',
      buttonText: 'Purchase Now',
      buttonLink: '/on-demand'
    }
  ];
